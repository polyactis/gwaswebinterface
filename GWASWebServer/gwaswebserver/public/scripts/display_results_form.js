...
function handleResponse(urlArray, field_ls) {
	...
	getOneResultRawBaseURL = urlArray[5];
	...
	// 2010-3-13 display the GWAS download link
	getOneResultRawURL = getOneResultRawBaseURL + '?' + url_query;
	var linkToDownloadGWAS = YAHOO.util.Dom.get('linkToDownloadGWAS');
	linkToDownloadGWAS.innerHTML = "<a href="+getOneResultRawURL+" target='_blank'>Click here to download this association result.</a>";
	linkToDownloadGWAS.style.display = 'block';
