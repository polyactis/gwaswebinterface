...
public class HelpDialog extends DialogBox implements ClickHandler{
	...
	HelpDialog(AccessionConstants constants, DisplayJSONObject jsonErrorDialog, String helpID)
	{
		...
		this.addCloseHandler(new DialogPopupListener());

		closeButton = new Button("close");
		closeButton.addClickHandler(this);

		editSaveButton = new Button(editCaption);
		editSaveButton.addClickHandler(new EditSaveClickListener());
	...
	private class DialogPopupListener implements CloseHandler<PopupPanel>
	{
	...
	private class EditSaveClickListener implements ClickHandler
	{
		public void onClick(ClickEvent cEvent)
		{
			/*
