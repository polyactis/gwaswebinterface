...
public class AssociationScatterChart extends ScatterChart {
	...
	*/
	...
	public Options setOptions(Options options){
		...
		options.set("max", this.maxY);
		options.set("titleX", "Chr "+this.chromosome);
		options.set("titleY", "-log Pvalue");
	...
	private class ScatterMouseMoveHandler implements MouseMoveHandler
	{
		public void onMouseMove(MouseMoveEvent event)
		{
			mouseX = event.getClientX();
